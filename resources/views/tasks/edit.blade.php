            ...
            <div class="row">
                <div class="col">
                    <form method="POST" action="{{ route('tasks.update', $task) }}">
                        ...
                        <h2 class="text-uppercase pb-4">Edit Task</h2>
                        <div class="form-group pb-2">
                            <label for="title"><h5 class="text-uppercase">Title</h5></label>
                            <input type="text" class="@error ('title') border-danger @enderror border rounded form-control" name="title" value="{{ $task->title }}" />
                        ...
                        <div class="form-group pb-2">
                            ...
                            <input type="date" class="@error ('due') border-danger @enderror border rounded form-control" name="due" value="{{ $task->due }}">
                            @error ('due')
